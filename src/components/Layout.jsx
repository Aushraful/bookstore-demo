  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-grow basis-0 items-center">
        <Link href="/" aria-label="Home page" className="flex items-center space-x-3">
...
export function Layout({ children, title, tableOfContents }) {
  ...
  return (
    <>
      ...
      <div className="w-full relative mx-auto justify-center">
        <div className="relative mx-auto flex max-w-8xl justify-center">
          <div className="flex-auto p-4 sm:p-6 lg:p-10">
            <article>
